app.controller("newAnswerController", ['$scope', 'usersFactory', 'questionsFactory','$location', '$routeParams', function($scope, usersFactory,questionsFactory, $location, $routeParams) {
