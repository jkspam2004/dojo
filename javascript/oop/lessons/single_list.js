...
// Write a remove tail! :)
SingleList.prototype.remove_tail = function (callback) {
...
Pretend you're in a technical interview and someone presented you with the above code. Talk through what's happening (feel free to draw it out on the whiteboard!).

A lot of typing was saved with sList.add().add()… Hopefully you can see how useful it is to return the instance of an object.
*/
