...
class BankAccount
  attr_reader :account_number, :checking_balance, :savings_balance, :num_accounts
  @num_accounts = 0

  # make class attribute num_accounts accessible by class instance
  class << self
